...
(function() {
  var HEIGHT, WIDTH, animation, axis, camera, cameraPosition, cameraPositions, color, handMesh, pointLight, renderer, scene, text, textGeo, textMaterial, visualizeBone, visualizeBones;
  ...
  visualizeBone = function(bone, parentMesh) {
    ...
    length = bone.children[0] ? vec3().subVectors(bone.children[0].position, bone.position).length() : 0.2;
